...
echo "=================================================="
echo "Alacritty + Zellij Setup Interactive Prompt"
echo "=================================================="
...
RUN_ALACRITTY=$(prompt_yes_no "Install Alacritty?" "y")
echo ""
...
echo "  Writes alacritty.toml to ~/.config/alacritty/ and sets default shell."
RUN_ALACRITTY_CONF=$(prompt_yes_no "Configure Alacritty?" "y")
AUTO_START_ZELLIJ="n"
if [[ "$RUN_ALACRITTY_CONF" == "y" ]]; then
    AUTO_START_ZELLIJ=$(prompt_yes_no "Should Alacritty auto start Zellij?" "n")
fi
echo ""
...
echo "  Downloads FiraCode Nerd Font and configures Alacritty to use it."
RUN_FONT=$(prompt_yes_no "Install FiraCode Nerd Font?" "y")
echo ""

# 14. Nautilus Integration
echo "Nautilus File Manager Integration:"
echo "  Adds 'Open in Alacritty' option to the files app right-click menu."
...
echo "  Sets Alacritty as the default terminal (x-terminal-emulator)."
RUN_DEFAULT_TERMINAL=$(prompt_yes_no "Configure system default terminal?" "y")
echo ""


# --- Main execution ---
echo "Starting Alacritty + Zellij setup..."
echo ""
...
if [[ "$RUN_ALACRITTY" == "y" ]]; then
    bash "$MODULES_DIR/install_alacritty.sh"
fi
...
if [[ "$RUN_ALACRITTY_CONF" == "y" ]]; then
    bash "$MODULES_DIR/configure_alacritty.sh" "$AUTO_START_ZELLIJ"
fi
...
echo ""
echo "Setup complete."
echo "You can now launch Alacritty from your application menu or by running: alacritty"
