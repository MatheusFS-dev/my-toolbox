...
for platform in linux-amd64 linux-arm64; do
    ...
    for required_entry in tb libexec/ libexec/tb-markdown-reader libexec/tb-markdown-reader-LICENSE commands.json completions/ completions/_tb completions/tb.bash completions/tb.ps1 packages/ packages/search/articles/ packages/macros/autohotkey/press_key_after_x_ms.ahk packages/macros/autohotkey/press_key_after_x_ms.json packages/macros/ydotool/press_key_after_x_ms.sh packages/macros/ydotool/press_key_after_x_ms.json version.txt; do
...
for required_entry in tb.exe libexec/ libexec/tb-markdown-reader.exe libexec/tb-markdown-reader-LICENSE commands.json completions/ completions/_tb completions/tb.bash completions/tb.ps1 packages/ packages/search/articles/ packages/macros/autohotkey/press_key_after_x_ms.ahk packages/macros/autohotkey/press_key_after_x_ms.json packages/macros/ydotool/press_key_after_x_ms.sh packages/macros/ydotool/press_key_after_x_ms.json version.txt; do
