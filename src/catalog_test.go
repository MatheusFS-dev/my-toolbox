...
func TestLoadCatalogRejectsInvalidCommands(t *testing.T) {
	...
	tests := []struct {
		...
		{"search reserved", `{"commands":[{"name":"search","description":"A","package":"p","visibility":"list","protocol":"builtin","entrypoints":{"linux-amd64":["builtin","a"],"linux-arm64":["builtin","a"],"windows-amd64":["builtin","a"]}}]}`, "reserved"},
